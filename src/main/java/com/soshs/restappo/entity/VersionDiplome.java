...
public class VersionDiplome implements Serializable {
    ...
    @ManyToMany(mappedBy = "versionDiplomeCollection")
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "versionDiplome")
    private Collection<SpeCaracteriseVdi> speCaracteriseVdiCollection;
    ...
    @XmlTransient
    public Collection<SpeCaracteriseVdi> getSpeCaracteriseVdiCollection() {
        return speCaracteriseVdiCollection;
    }

    public void setSpeCaracteriseVdiCollection(Collection<SpeCaracteriseVdi> speCaracteriseVdiCollection) {
        this.speCaracteriseVdiCollection = speCaracteriseVdiCollection;
    }
    ...
    public String toString() {
        return "com.soshs.restappo.entity.VersionDiplome[ versionDiplomePK=" + versionDiplomePK + " ]";
    }
