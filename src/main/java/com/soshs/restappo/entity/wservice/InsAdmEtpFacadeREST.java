 ...
 */
@Stateless
@Path("com.soshs.restappo.entity.insadmetp")
public class InsAdmEtpFacadeREST extends AbstractFacade<InsAdmEtp> {
    ...
    private InsAdmEtpPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.restappo.entity.InsAdmEtpPK key = new com.soshs.restappo.entity.InsAdmEtpPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.restappo.entity.InsAdmEtpPK key = getPrimaryKey(id);
