 ...
 */
@Stateless
@Path("com.soshs.restappo.entity.etablissement")
public class EtablissementFacadeREST extends AbstractFacade<Etablissement> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Etablissement entity) {
        super.edit(entity);
    }
    ...
    public Etablissement find(@PathParam("id") String id) {
