...
import com.soshs.restappo.entity.LseRegroupeElpPK;
 ...
 */
@Stateless
@Path("com.soshs.restappo.entity.lseregroupeelp")
public class LseRegroupeElpFacadeREST extends AbstractFacade<LseRegroupeElp> {
    ...
    private LseRegroupeElpPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.restappo.entity.LseRegroupeElpPK key = new com.soshs.restappo.entity.LseRegroupeElpPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.restappo.entity.LseRegroupeElpPK key = getPrimaryKey(id);
