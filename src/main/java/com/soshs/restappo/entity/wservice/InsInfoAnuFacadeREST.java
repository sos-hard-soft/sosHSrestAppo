 ...
 */
@Stateless
@Path("com.soshs.restappo.entity.insinfoanu")
public class InsInfoAnuFacadeREST extends AbstractFacade<InsInfoAnu> {
    ...
    private InsInfoAnuPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        com.soshs.restappo.entity.InsInfoAnuPK key = new com.soshs.restappo.entity.InsInfoAnuPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        com.soshs.restappo.entity.InsInfoAnuPK key = getPrimaryKey(id);
