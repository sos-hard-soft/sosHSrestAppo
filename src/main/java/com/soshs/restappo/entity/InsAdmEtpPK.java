 ...
 */
@Embeddable
public class InsAdmEtpPK implements Serializable {
    ...
    @Basic(optional = false)
    @NotNull
    @Column(name = "NUM_OCC_IAE")
    private short numOccIae;

    public InsAdmEtpPK() {
    }

    public InsAdmEtpPK(String codAnu, int codInd, String codEtp, short codVrsVet, short numOccIae) {
        this.codAnu = codAnu;
        this.codInd = codInd;
        this.codEtp = codEtp;
        this.codVrsVet = codVrsVet;
        this.numOccIae = numOccIae;
    }
    ...
    public short getNumOccIae() {
        return numOccIae;
    }

    public void setNumOccIae(short numOccIae) {
        this.numOccIae = numOccIae;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InsAdmEtpPK)) {
            return false;
        }
        InsAdmEtpPK other = (InsAdmEtpPK) object;
        ...
        if (this.numOccIae != other.numOccIae) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.soshs.restappo.entity.InsAdmEtpPK[ codAnu=" + codAnu + ", codInd=" + codInd + ", codEtp=" + codEtp + ", codVrsVet=" + codVrsVet + ", numOccIae=" + numOccIae + " ]";
    }
