...
public class SitSociale implements Serializable {
    ...
    @OneToMany(mappedBy = "codSoc")
    private Collection<Bourse> bourseCollection;
    ...
    @XmlTransient
    public Collection<Bourse> getBourseCollection() {
        return bourseCollection;
    }

    public void setBourseCollection(Collection<Bourse> bourseCollection) {
        this.bourseCollection = bourseCollection;
    }
    ...
    public String toString() {
        return "com.soshs.restappo.entity.SitSociale[ codSoc=" + codSoc + " ]";
    }
