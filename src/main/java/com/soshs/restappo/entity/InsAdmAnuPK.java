 ...
 */
@Embeddable
public class InsAdmAnuPK implements Serializable {
    ...
    public InsAdmAnuPK(String codAnu, int codInd) {
        this.codAnu = codAnu;
        this.codInd = codInd;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InsAdmAnuPK)) {
            return false;
        }
        InsAdmAnuPK other = (InsAdmAnuPK) object;
    ...
    public String toString() {
        return "com.soshs.restappo.entity.InsAdmAnuPK[ codAnu=" + codAnu + ", codInd=" + codInd + " ]";
    }
