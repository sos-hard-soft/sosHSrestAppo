...
public class InsAdmAnu implements Serializable {
    ...
    @ManyToMany(mappedBy = "insAdmAnuCollection")
    private Collection<Droit> droitCollection;
    @ManyToMany(mappedBy = "insAdmAnuCollection")
    private Collection<AideFinanciere> aideFinanciereCollection;
    ...
    @XmlTransient
    public Collection<AideFinanciere> getAideFinanciereCollection() {
        return aideFinanciereCollection;
    }

    public void setAideFinanciereCollection(Collection<AideFinanciere> aideFinanciereCollection) {
        this.aideFinanciereCollection = aideFinanciereCollection;
    }
    ...
    public String toString() {
        return "com.soshs.restappo.entity.InsAdmAnu[ insAdmAnuPK=" + insAdmAnuPK + " ]";
    }
