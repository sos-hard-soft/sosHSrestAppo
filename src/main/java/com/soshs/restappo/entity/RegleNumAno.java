...
public class RegleNumAno implements Serializable {
    ...
    private Collection<PeriodeAno> periodeAnoCollection;
    ...
    @XmlTransient
    public Collection<PeriodeAno> getPeriodeAnoCollection() {
        return periodeAnoCollection;
    }

    public void setPeriodeAnoCollection(Collection<PeriodeAno> periodeAnoCollection) {
        this.periodeAnoCollection = periodeAnoCollection;
    }
    ...
    public String toString() {
        return "com.soshs.restappo.entity.RegleNumAno[ codRna=" + codRna + " ]";
    }
